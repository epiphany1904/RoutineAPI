...
namespace Routine.Api.Controllers
{
  ...
  // [Route("api/[controller]")]
    public class CompaniesController : ControllerBase
    {
        ...
        [Produces("application/json","application/vnd.company.hateoas+json", "application/vnd.company.company.friendly+json",
            "application/vnd.company.company.friendly.hateoas+json", "application/vnd.company.company.full+json", "application/vnd.company.company.full.hateoas+json")]
        ...
        public async Task<IActionResult> GetCompany(Guid companyId, string fields,[FromHeader(Name = "Accept")] string mediaType)
        {
            ...
            var primariyMediaType = includeLinks
                ? parsedMediaType.SubTypeWithoutSuffix.Substring(0, parsedMediaType.SubTypeWithoutSuffix.Length - 8)
                : parsedMediaType.SubTypeWithoutSuffix;
            if (primariyMediaType == "vnd.company.company.full")
            {
        ...
        public async Task<IActionResult> DeleteCompany(Guid companyId)
        {
            ...
            await _companyRepository.GetEmployeesAsync(companyId, null); //需要把Employee加载出来！！！
        ...
        private IEnumerable<LinkDto> CreateLinksForCompany(Guid companyId, string fields)
        {
            ...
            {
                links.Add(new LinkDto(Url.Link(nameof(GetCompany),new
                {
                    companyId
                }),"self","GET"));
            ...
            links.Add(new LinkDto(Url.Link(nameof(DeleteCompany), new
            {
                companyId
            }), "delete_company", "DELETE"));


            links.Add(new LinkDto(Url.Link(nameof(EmployeesController.CreateEmployeeForCompany), new
            {
                companyId
            }), "create_employee_for_company", "POST"));

            links.Add(new LinkDto(Url.Link(nameof(EmployeesController.GetEmployeesForCompany), new
            {
                companyId
            }), "employees", "GET"));
            return links;
